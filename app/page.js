...
export const metadata={title:"Domy modułowe premium pod klucz",description:"Prefabrykowane domy modułowe 68–156 m². Montaż w 3–5 dni i przewidywalny proces od projektu do odbioru.",openGraph:{title:"Domy modułowe premium pod klucz | NORDHUS",description:"Prefabrykowane domy modułowe 68–156 m². Montaż w 3–5 dni i przewidywalny proces od projektu do odbioru.",images:[asset("/images/hero.jpg")],type:"website"},twitter:{card:"summary_large_image",title:"Domy modułowe premium pod klucz | NORDHUS",description:"Prefabrykowane domy modułowe 68–156 m². Montaż w 3–5 dni i przewidywalny proces od projektu do odbioru.",images:[asset("/images/hero.jpg")]}};
...
<Hero image="/images/hero.jpg" alt="Dom modułowy NORDHUS w sosnowym lesie" title="DOM GOTOWY W PIĘĆ MIESIĘCY" text="Stała cena ustalona przed produkcją. Montaż na działce w trzy dni." primary={{href:"/modele",label:"ZOBACZ MODELE"}} secondary={{href:"/kontakt",label:"ZAPYTAJ O WYCENĘ"}}/>
...
<section className="section-space"><Container><p className="eyebrow">ZAKRES CENY</p><h2 className="mt-5">Co jest w cenie, a co pozostaje po stronie działki</h2></Container><div className="relative mt-10 h-[40vh] min-h-[320px] w-full overflow-hidden"><Image src={asset("/images/produkcja.jpg")} alt="Produkcja modułów NORDHUS" fill className="object-cover" sizes="100vw" placeholder="blur" blurDataURL={BLUR_DATA_URL}/></div><Container><div className="mt-10 grid md:grid-cols-2"><div className="pb-8 md:border-r md:border-[var(--line)] md:pb-0 md:pr-10"><h3>W cenie bazowej</h3><ul className="mt-6 space-y-3">{included.map(x=><li key={x}>— {x}</li>)}</ul></div><div className="border-t border-[var(--line)] pt-8 md:border-t-0 md:pl-10 md:pt-0"><h3>Po stronie działki</h3><ul className="mt-6 space-y-3">{excluded.map(x=><li key={x}>— {x}</li>)}</ul></div></div></Container></section>

<FullBleedImage image="/images/realizacja-1.jpg" alt="Wizualizacja domu NORDHUS nad jeziorem" eyebrow="ZREALIZOWANE" title="Ten sam system. Inny kontekst." text="Zdjęcia w serwisie są wizualizacjami demonstracyjnymi. Pokazują, jak ta sama logika modułowa może pracować na różnych działkach i w różnych warunkach."/>
