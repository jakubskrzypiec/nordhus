...
export default function FullBleedImage({image,alt,eyebrow,title,text,align="left"}){
 return <section className="relative min-h-[78svh] overflow-hidden bg-[#20201e] text-white">
  <div className="reveal-image absolute inset-0"><Image src={image} alt={alt} fill quality={90} className="object-cover" sizes="100vw" placeholder="blur" blurDataURL={BLUR_DATA_URL}/></div>
